...
*Sombras de Mordor* es un ejemplo brillante de hibridación en múltiples niveles: **narrativo, técnico, visual y cultural**. Une literatura, cine e IA en una sola experiencia que reimagina la *Tierra Media*, y con ella el universo de *El Señor de los Anillos*, desde la lógica del software.
...
En *Pokémon GO*, la realidad aumentada y la capa de geolocalización no actúan como elementos añadidos, sino como un **medio híbrido propio**, que transforma la forma de jugar y desplazarse por el espacio urbano. La hibridación se produce en la **interfaz**, al superponer el entorno digital sobre el físico, y también en **la forma en que el juego interpreta y representa la información espacial y contextual en tiempo real**, como la posición del jugador, los eventos del entorno o los Pokémons disponibles.
